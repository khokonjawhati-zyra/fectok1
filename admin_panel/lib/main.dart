...
class _AdminScaffoldState extends State<AdminScaffold> {
  ...
  String _healUrl(String url) {
    ...
    // Scan and replace ANY legacy IP with the current host
                        ...
                        Row(
                          children: [
                            ...
                            if (u['is_verified'] == true) ...[
                              ...
                              const Icon(Icons.verified, color: Color(0xFF00FFFF), size: 14),
                            ],
                          ],
                        ),
                        if (isOnline) ...[
